...
BAZEL_COMMAND_LIST="analyze-profile build canonicalize-flags clean coverage dump fetch help info license mobile-install print_action query run shutdown test version"
BAZEL_INFO_KEYS="
workspace
install_base
output_base
...
--noincompatible_checked_arithmetic
...
--noincompatible_disallow_keyword_only_args
--incompatible_disallow_set_constructor
--noincompatible_disallow_set_constructor
...
--noincompatible_string_is_not_iterable
--logging=
--profile=path
...
--experimental_android_throw_on_resource_conflict
--noexperimental_android_throw_on_resource_conflict
--experimental_build_event_json_file_path_conversion
--noexperimental_build_event_json_file_path_conversion
...
--experimental_use_manifest_from_resource_apk
--noexperimental_use_manifest_from_resource_apk
--explain=path
...
--java_classpath={off,javabuilder,blaze}
--java_debug
--java_deps
--nojava_deps
...
--objc_header_scanner_tool=label
--objc_header_thinning_partition_size=
